  ...
  return (
    <>
      <div className="myContainer border-t border-gray-300 !py-10">
        <div className=" flex flex-col md:flex-row gap-10 md:items-center">
          <div>
            <div className="flex items-center gap-10">
              ...
              <img alt="logo" src={deepbody} width={120} />
            </div>
            <p className="regular mt-5 text-gray-500 md:w-[60%] w-full text-sm leading-6  ">
              DeepBeat ID: Redefining Travel Authentication with Heart ECG
              Technology for Effortless Journeys Ahead.
            </p>
        ...
        <div className="md:flex items-center justify-between">
          <div className="mt-8 flex items-center">
            <p className="roboto font-bold text-primary text-4xl">Made By</p>
            <img
              alt="deepbody"
              src={deepbody_hor}
              className="ml-4"
      ...
      <div className="bg-primary text-xs md:text-sm myContainer h-16 md:h-14 flex justify-center text-center items-center text-white">
        <p>(@) 2024 DeepBeatID Limited. All Rights Reserved.</p>
      </div>
    </>
  );
};
